...
def verify(img1_path, img2_path = '', model_name ='VGG-Face', distance_metric = 'cosine', model = None, enforce_detection = True, detector_backend = 'opencv'):
	...
	if model == None:
		...
		# 우리 모델 추가=====================================================================================================
			...
			print("Using resnet_50-2 model backend and", distance_metric,"distance.")
			model = load_model('/content/drive/My Drive/기업프로젝트-라젠/deepface/deepface/models/resnet_50-2.h5',  custom_objects={'KerasLayer':hub.KerasLayer})


		elif model_name == 'mobilenet':
			print("Using mobilenet_v2 model backend and", distance_metric,"distance.")
			model = load_model('/content/drive/My Drive/기업프로젝트-라젠/deepface/deepface/models/mobilenet_v2.h5',  custom_objects={'KerasLayer':hub.KerasLayer})

		elif model_name == 'facenet_abouttime':
			print("Using facenet_abouttime model backend and", distance_metric,"distance.")
			model = load_model('/content/drive/My Drive/기업프로젝트-라젠/deepface/deepface/models/facenet2.h5')
		...
		# 	print("Using inception_v4 model backend and", distance_metric,"distance.")
		# 	model = load_model('/content/drive/My Drive/기업프로젝트-라젠/deepface/deepface/models/inception_v4.h5', custom_objects={'KerasLayer':hub.KerasLayer})		
