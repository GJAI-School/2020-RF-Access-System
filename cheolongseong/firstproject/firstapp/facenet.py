...
from tensorflow.python.keras.layers import Input, Conv2D, BatchNormalization, Activation
from tensorflow.python.keras.layers import MaxPooling2D, Concatenate, Lambda, add
from tensorflow.python.keras.layers import GlobalAveragePooling2D, Dropout, Dense
